 ...
 */
public class RadarListener implements LocationListener {

    RadarActivity radarActivity;

    public RadarActivity getRadarActivity() {
        return radarActivity;
    }

    public void setRadarActivity(RadarActivity radarActivity) {
    ...
    public void onLocationChanged(Location loc) {
        ...
        this.radarActivity.setLocation(loc);
    }
